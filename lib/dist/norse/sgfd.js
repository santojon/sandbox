        ...
        with(Sgfd.Base) {
            ...
            progressiveLoad(loadList, loadScript, function () {
                ...
                with(appConfig) {
                    ...
                    if (!conf['templates']) conf['templates'] = false;
                ...
                with(autoMerge(appConfig.front, appConfig.back, appConfig.conf)) {
                    ...
                    // Load template files
                    if (templates) {
                        progressiveLoad(views, loadTemplate);
                    }
                    ...
                    progressiveLoad(dependencies, loadScript, function () {
                        ...
                        if (appConfig.conf['pageLoader']) {
                            container['pages'] = new container[pageLoader](container.views, container, {
                                appContainer: 'app',
                                autoAttach: true,
                                manualMappings: true,
                                inPage: true
...
Sgfd.Base = {
    ...
    /**
     * Function responsible to fetch a template
     */
    loadTemplate: function (url, callback) {
        // Adding the script tag to the head as suggested before
        var app = document.getElementsByTagName('app')[0];
        var script = document.createElement('script');
        script.type = 'text/frigga';
        script.src = 'templates/pages/_' + url + '.frgg';
    ...
    /**
     * Function responsible to fetch templates
     */
